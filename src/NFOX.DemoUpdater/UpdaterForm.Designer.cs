...
partial class UpdaterForm
{
    ...
    private void InitializeComponent()
    {
        ...
        rootLayout.Controls.Add(lblCurrentVersionCaption, 0, 0);
        rootLayout.Controls.Add(lblCurrentVersion, 1, 0);
        rootLayout.Controls.Add(lblLatestVersionCaption, 0, 1);
        rootLayout.Controls.Add(lblLatestVersion, 1, 1);
        rootLayout.Controls.Add(lblCurrentDbCaption, 0, 2);
        rootLayout.Controls.Add(lblCurrentDb, 1, 2);
        rootLayout.Controls.Add(lblTargetDbCaption, 0, 3);
        rootLayout.Controls.Add(lblTargetDb, 1, 3);
        rootLayout.Controls.Add(lblUpdateNameCaption, 0, 4);
        rootLayout.Controls.Add(lblUpdateName, 1, 4);
        rootLayout.Controls.Add(lblReleaseNotesCaption, 0, 5);
        rootLayout.Controls.Add(txtReleaseNotes, 1, 5);
        rootLayout.Controls.Add(lblDownloadCaption, 0, 6);
        rootLayout.Controls.Add(progressDownload, 1, 6);
        rootLayout.Controls.Add(lblMigrationCaption, 0, 7);
        rootLayout.Controls.Add(progressMigration, 1, 7);
        rootLayout.Controls.Add(lblStatusCaption, 0, 8);
        rootLayout.Controls.Add(txtStatus, 1, 8);
        ...
        ConfigureButton(btnCheck, "Check", 100);
        btnCheck.Click += btnCheck_Click;
        ConfigureButton(btnDownloadUpdate, "Download and Update", 170);
